...
RUN R -e "remotes::install_github(c('jackbmiller/pstat5lsSBI', 'rstudio/gradethis', 'STATS250SBI/stats250sbi', 'quarto-dev/quarto-r', 'rstudio-education/dsbox'), Ncpus = parallel::detectCores())"
