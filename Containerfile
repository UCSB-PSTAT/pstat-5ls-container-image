...
RUN R -e "pak::pak('jackbmiller/pstat5lsSBI', 'rstudio/gradethis', 'STATS250SBI/stats250sbi', 'quarto-dev/quarto-r', 'rstudio-education/dsbox', Ncpus = parallel::detectCores())"
